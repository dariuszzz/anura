use crate::{
    ...
    uitree::UiTree, context::{IndigoContext}, handle::UntypedHandle, widget::Widget, graphics::IndigoRenderer, prelude::{IndigoError, Layout},
};
...
pub trait ViewWrapperTrait<A: App<R>, R: IndigoRenderer> {
    ...
    fn render_view(&self, _renderer: &mut R) -> Result<Vec<R::RenderCommand>, IndigoError<R::ErrorMessage>>;
}
    ...
    R: IndigoRenderer + 'static
{
    ...
    fn render_view(&self, renderer: &mut R) -> Result<Vec<R::RenderCommand>, IndigoError<R::ErrorMessage>> {
